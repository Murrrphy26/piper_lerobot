...
remote_gpu_load_config() {
  local config_path="${1:-configs/record_pick_cube_pi05.json}"
  local repo_root="${2:-}"
...
remote = cfg.get("remote_gpu", {})
deployment = cfg.get("deployment", {})
gpu_server = deployment.get("gpu_server", {})
async_cfg = cfg.get("async_inference", {})
policy_server = cfg.get("policy_server", {})
